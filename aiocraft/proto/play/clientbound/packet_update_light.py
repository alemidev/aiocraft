...
class PacketUpdateLight(Packet):
	...
	def __init__(self, 
		...
		blockLightMask:Union[int,list] | None = None,
		chunkX:int | None = None,
		chunkZ:int | None = None,
		data:bytes | None = None,
		emptyBlockLightMask:Union[int,list] | None = None,
		emptySkyLightMask:Union[int,list] | None = None,
		skyLight:list | None = None,
		skyLightMask:Union[int,list] | None = None,
