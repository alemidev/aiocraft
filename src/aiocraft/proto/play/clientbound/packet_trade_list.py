...
class PacketTradeList(Packet):
	...
	def __init__(self, 
		canRestock:bool | None = None,
		experience:int | None = None,
		isRegularVillager:bool | None = None,
		trades:list | None = None,
		villagerLevel:int | None = None,
	...
	_definitions : Dict[int, List[Tuple[str, Type]]] = {
		...
		757 : [ ( 'windowId', VarInt ), ( 'trades', ArrayType(StructType(( 'inputItem1', Slot ), ( 'outputItem', Slot ), ( 'inputItem2', OptionalType(Slot, ) ), ( 'tradeDisabled', Boolean ), ( 'nbTradeUses', Int ), ( 'maximumNbTradeUses', Int ), ( 'xp', Int ), ( 'specialPrice', Int ), ( 'priceMultiplier', Float ), ( 'demand', Int ), ), Byte, ) ), ( 'villagerLevel', VarInt ), ( 'experience', VarInt ), ( 'isRegularVillager', Boolean ), ( 'canRestock', Boolean ) ],
		758 : [ ( 'windowId', VarInt ), ( 'trades', ArrayType(StructType(( 'inputItem1', Slot ), ( 'outputItem', Slot ), ( 'inputItem2', OptionalType(Slot, ) ), ( 'tradeDisabled', Boolean ), ( 'nbTradeUses', Int ), ( 'maximumNbTradeUses', Int ), ( 'xp', Int ), ( 'specialPrice', Int ), ( 'priceMultiplier', Float ), ( 'demand', Int ), ), Byte, ) ), ( 'villagerLevel', VarInt ), ( 'experience', VarInt ), ( 'isRegularVillager', Boolean ), ( 'canRestock', Boolean ) ],
		759 : [ ( 'windowId', VarInt ), ( 'trades', ArrayType(StructType(( 'inputItem1', Slot ), ( 'outputItem', Slot ), ( 'inputItem2', Slot ), ( 'tradeDisabled', Boolean ), ( 'nbTradeUses', Int ), ( 'maximumNbTradeUses', Int ), ( 'xp', Int ), ( 'specialPrice', Int ), ( 'priceMultiplier', Float ), ( 'demand', Int ), ), Byte, ) ), ( 'villagerLevel', VarInt ), ( 'experience', VarInt ), ( 'isRegularVillager', Boolean ), ( 'canRestock', Boolean ) ],
		760 : [ ( 'windowId', VarInt ), ( 'trades', ArrayType(StructType(( 'inputItem1', Slot ), ( 'outputItem', Slot ), ( 'inputItem2', Slot ), ( 'tradeDisabled', Boolean ), ( 'nbTradeUses', Int ), ( 'maximumNbTradeUses', Int ), ( 'xp', Int ), ( 'specialPrice', Int ), ( 'priceMultiplier', Float ), ( 'demand', Int ), ), VarInt, ) ), ( 'villagerLevel', VarInt ), ( 'experience', VarInt ), ( 'isRegularVillager', Boolean ), ( 'canRestock', Boolean ) ],
		761 : [ ( 'windowId', VarInt ), ( 'trades', ArrayType(StructType(( 'inputItem1', Slot ), ( 'outputItem', Slot ), ( 'inputItem2', Slot ), ( 'tradeDisabled', Boolean ), ( 'nbTradeUses', Int ), ( 'maximumNbTradeUses', Int ), ( 'xp', Int ), ( 'specialPrice', Int ), ( 'priceMultiplier', Float ), ( 'demand', Int ), ), VarInt, ) ), ( 'villagerLevel', VarInt ), ( 'experience', VarInt ), ( 'isRegularVillager', Boolean ), ( 'canRestock', Boolean ) ]
	}
