...
class PacketUnlockRecipes(Packet):
	...
	def __init__(self, 
		...
		blastFurnaceOpen:bool | None = None,
		craftingBookOpen:bool | None = None,
		filteringBlastFurnace:bool | None = None,
		filteringCraftable:bool | None = None,
		filteringSmeltable:bool | None = None,
		filteringSmoker:bool | None = None,
		notification:bool | None = None,
		recipes:list | None = None,
		recipes1:list | None = None,
		recipes2:Union[Union[None, list],list] | None = None,
		smeltingBookOpen:bool | None = None,
		smokerBookOpen:bool | None = None,
		**kwargs
	):
		super().__init__(
			action=action,
